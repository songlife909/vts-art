  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        email: 'Email',
        phone: 'Phone',
        preferredSession: 'Preferred Time (Saturday, May 16, 2026)',
        sessionOption10: 'Saturday, May 16 \u00B7 10:00 AM',
  ...
  ko: {
    ...
    contact: {
      ...
      form: {
        ...
        email: '이메일',
        phone: '전화번호',
        preferredSession: '희망 시간 (5월 16일 토요일)',
        sessionOption10: '5월 16일 (토) \u00B7 오전 10시',
